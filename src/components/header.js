...
<div className="page-header -i navbar navbar-fixed-top">
	<div className="page-header-inner">
		...
		<a href={null} className="menu-toggler responsive-toggler" data-toggle="collapse" data-target=".navbar-collapse">
		</a>
		<div className="top-menu">
			<ul className="nav navbar-nav pull-right">
				<li className="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
					<a href={null} className="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
				...
				<li className="dropdown dropdown-quick-sidebar-toggler">
					<a href={null} className="dropdown-toggle">
